...
from src.plotters.plot_styles.bw_cb_fit_style import bw_cb_fit_style
from src.plotters.plot_styles.paper_style import paper_style
...
class DataConstants:
    ...
    time_stability_eta_bins_low = [0, 1.0, 1.2, 1.566, 2.0]
    time_stability_eta_bins_high = [1.0, 1.2, 1.4442, 2.0, 2.5]
    ...
    SYST_CUTS = {
        "EBin": {
            "HighR9": {
                ...
                "ele_cats": (0, 1, R9_BOUNDARY, -1, -1, -1, -1),
            },
            "LowR9": {
                "eta_cuts": ((-1, 1), (-1, 1)),
                "r9_cuts": ((-1, R9_BOUNDARY), (-1, R9_BOUNDARY)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (0, 1, -1, R9_BOUNDARY, -1, -1, -1),
            },
        },
        "EBout": {
            "HighR9": {
                ...
                "r9_cuts": ((R9_BOUNDARY, -1), (R9_BOUNDARY, -1)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (1, 1.4442, R9_BOUNDARY, -1, -1, -1, -1),
            },
            "LowR9": {
                "eta_cuts": ((1, 1.4442), (1, 1.4442)),
                "r9_cuts": ((-1, R9_BOUNDARY), (-1, R9_BOUNDARY)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (1, 1.4442, -1, R9_BOUNDARY, -1, -1, -1),
            },
        },
        "EEin": {
            "HighR9": {
                ...
                "r9_cuts": ((R9_BOUNDARY, -1), (R9_BOUNDARY, -1)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (1.566, 2, R9_BOUNDARY, -1, -1, -1, -1),
            },
            "LowR9": {
                "eta_cuts": ((1.566, 2), (1.566, 2)),
                "r9_cuts": ((-1, R9_BOUNDARY), (-1, R9_BOUNDARY)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (1.566, 2, -1, R9_BOUNDARY, -1, -1, -1),
            },
        },
        "EEout": {
            "HighR9": {
                ...
                "r9_cuts": ((R9_BOUNDARY, -1), (R9_BOUNDARY, -1)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (2, 2.5, R9_BOUNDARY, -1, -1, -1, -1),
            },
            "LowR9": {
                "eta_cuts": ((2, 2.5), (2, 2.5)),
                "r9_cuts": ((-1, R9_BOUNDARY), (-1, R9_BOUNDARY)),
                "et_cuts": (MIN_PT_LEAD, MIN_PT_SUB),
                "ele_cats": (2, 2.5, -1, R9_BOUNDARY, -1, -1, -1),
            },
        },
    }
...
class PlottingConstants:
    ...
    def get_plotting_function(self, style):
        if style in self.plotting_functions.keys():
            ...
            print(
                f"[ERROR] style {style} does not have a corresponding plotting function"
            )
