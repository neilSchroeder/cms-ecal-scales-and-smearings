...
def test_write_results():
    ...
    class MyArgs:
        def __init__(self, scales_file, cats_file, time_stability, from_condor, closure, output):
    ...
    write_results(
        MyArgs("datFiles/step1_ul18_test_scales.dat", "config/cats_step2.tsv", False, False, False, "test"),
        [1]*8 + [0.02]*8
    )
