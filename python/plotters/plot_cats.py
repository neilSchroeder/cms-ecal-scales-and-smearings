...
def plot_1Dscan(plot_dir, scan_file, zcats):
    ...
    for i,row in scales_df.iterrows():
        ...
        if i > 49:
            ...
            scan_vals = np.arange(row[8]*0.8, row[8]*0.95, (row[8]*0.95-row[8]*0.8)/15)
            scan_vals = np.append(scan_vals, np.arange(row[8]*0.95, row[8]*0.975, (row[8]*0.975-row[8]*0.95)/5))
            ...
            scan_vals = np.append(scan_vals, np.arange(row[8]*1.05, row[8]*1.5, (row[8]*1.5-row[8]*1.05)/45))
