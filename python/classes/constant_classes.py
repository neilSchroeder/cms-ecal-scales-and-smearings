            ...
            annotations = {
                ...
                'plot_title': {
                    'annot': {
                        ...
                        "invMass_lead_Pt-32-40": "32 GeV $ < \bm{p_{T, lead}^{e}} < $ 40 GeV",
                        "invMass_lead_Pt-40-55": "40 GeV $ < \bm{p_{T, lead}^{e}} < $ 55 GeV",
                        "invMass_lead_Pt-55-65": "55 GeV $ < \bm{p_{T, lead}^{e}} < $ 65 GeV",
                        "invMass_lead_Pt-65-90": "65 GeV $ < \bm{p_{T, lead}^{e}} < $ 90 GeV",
                        "invMass_lead_Pt-90-Inf": "90 GeV $ < \bm{p_{T, lead}^{e}}$",
                        "invMass_diag_Pt-32-40": "32 GeV $ < \bm{p_{T}^{e}} < $ 40 GeV",
                        "invMass_diag_Pt-40-55": "40 GeV $ < \bm{p_{T}^{e}} < $ 55 GeV",
                        "invMass_diag_Pt-55-65": "55 GeV $ < \bm{p_{T}^{e}} < $ 65 GeV",
                        "invMass_diag_Pt-65-90": "65 GeV $ < \bm{p_{T}^{e}} < $ 90 GeV",
                        "invMass_diag_Pt-90-Inf": "90 GeV $ < \bm{p_{T}^{e} }$",
                    },
                    'xy': (0.1, 0.9),
                    'xycoords': 'axes fraction',
                    'ha': 'left',
