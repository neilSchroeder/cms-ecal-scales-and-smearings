...
def apply_systs(df, systs):
    ...
    for i,row in systs.iterrows():
        ...
        df.loc[eta_mask_low&eta_mask_high&r9_mask_low&r9_mask_high&gain_mask,10] = row[7]*df.loc[eta_mask_low&eta_mask_high&gain_mask,9]/100.
...
def main():
    ...
    parser.add_argument("-i","--inFile", required=True,
        help="input file to add MC run entries to")
