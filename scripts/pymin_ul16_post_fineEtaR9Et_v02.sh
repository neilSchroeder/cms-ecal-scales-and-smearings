./pymin.py -i config/ul16_post.dat \
    ...
    -s condor/ul16_postVFP_RunFineEtaR9Et_v01_2022-03-17/step2closure_ul16_postVFP_RunFineEtaR9Et_v01_2022-03-17_scales.dat \
    ...
    -o ul16_postVFP_RunFineEtaR9Et_v02_2022-03-21 \
    --closure \
    --condor \
    --queue "nextweek"
